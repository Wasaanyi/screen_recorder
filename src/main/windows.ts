...
export function createControlWindow(): BrowserWindow {
  ...
  if (VITE_DEV_SERVER_URL) {
    ...
    controlWindow.loadFile(join(__dirname, '../../dist/src/renderer/control/index.html'));
  }
...
export function createOverlayWindow(): BrowserWindow {
  ...
  if (VITE_DEV_SERVER_URL) {
    ...
    overlayWindow.loadFile(join(__dirname, '../../dist/src/renderer/overlay/index.html'));
  }
...
export function createWebcamWindow(): BrowserWindow {
  ...
  if (VITE_DEV_SERVER_URL) {
    ...
    webcamWindow.loadFile(join(__dirname, '../../dist/src/renderer/webcam/index.html'));
  }
...
export function createEditorWindow(videoPath: string): BrowserWindow {
  ...
  if (VITE_DEV_SERVER_URL) {
    ...
    editorWindow.loadFile(join(__dirname, '../../dist/src/renderer/editor/index.html'), {
